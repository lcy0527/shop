            ...
            <div class="layui-tab layui-tab-brief" lay-filter="docDemoTabBrief">
              ...
              <div class="layui-tab-content" >
                <div class="layui-tab-item layui-show">
                    ...
                    <xblock>
          <button class="layui-btn" onclick="download_picadd('添加信息','download_picadd.jsp','600','500')"><i class="layui-icon">&#xe608;</i>添加</button>
                ...
                <tbody id="x-img">
                    <tr>
                        ...
                        <td align="center" width="7%">
                            <img src="images/tupian2.jpg" alt="" width="56" height="56">
                        </td>
                        <td >2017-07-15</td>
                        <td >叙述内容</td>
                        <td class="td-status">
                        ...
                        <td class="td-manage">
                            ...
                            <a title="修改" href="javascript:;" onclick="download_picedit('修改','download_picedit.jsp','4','','510')"
                    ...
                    <tr>
                        ...
                        <td width="7%">产品图片</td>
                        <td align="center" width="7%">
                            <img src="images/tupian3.jpg" alt="" width="56" height="56">
                        </td>
                        <td >2017-07-15</td>
                        <td >叙述内容</td>
                        <td class="td-status">
                    ...
                    <tr>
                        ...
                        <td width="7%">公司图片</td>
                        <td align="center" width="7%">
                            <img src="images/tupian4.jpg" alt="" width="56" height="56">
                        </td>
                        <td >2017-07-15</td>
                        <td >叙述内容</td>
                        <td class="td-status">
            ...
            <div id="page"></div>
                ...
                <div class="layui-tab-item">
                    <form class="layui-form layui-form-pane" action="">
                     ...
                     <xblock>
          <button class="layui-btn" onclick="download_bookadd('添加信息','download_bookadd.jsp','600','500')"><i class="layui-icon">&#xe608;</i>添加</button>
          <button class="layui-btn layui-btn-danger"><i class="layui-icon"><img src="images/look2.png" width="15" height="15"></img></i>查看</button>
          ...
          <span class="x-right" style="line-height:40px">共有数据：88 条</span></xblock>
                ...
                <tbody id="x-img">
                    <tr>
                        ...
                        <td width="7%">交际书</td>
                        <td align="center" width="7%">
                            <img src="images/shuji1.jpg" alt="" width="56" height="56">
                        </td>
                        <td >2017-07-15</td>
                        <td >叙述内容</td>
                        <td class="td-status">
                        ...
                        <td class="td-manage">
                            ...
                            <a title="修改" href="javascript:;" onclick="download_bookedit('修改','download_bookedit.jsp','4','','510')"
                            class="ml-5" style="text-decoration:none">
                                <i class="layui-icon">&#xe642;</i>
                            </a>
                            <a title="删除" href="javascript:;" onclick="banner_del(this,'1')" 
                    ...
                    <tr>
                        ...
                        <td width="7%">催眠书</td>
                        <td align="center" width="7%">
                            <img src="images/shuji2.jpg" alt="" width="56" height="56">
                        </td>
                        <td >2017-07-15</td>
                        <td >叙述内容</td>
                        <td class="td-status">
                    ...
                    <tr>
                        ...
                        <td width="7%">心理健康书</td>
                        <td align="center" width="7%">
                            <img src="images/shuji3.jpg" alt="" width="56" height="56">
                        </td>
                        <td >2017-07-15</td>
                        <td >叙述内容</td>
                        <td class="td-status">
                    ...
                    <tr>
                        ...
                        <td width="7%">健康饮食书</td>
                        <td align="center" width="7%">
                            <img src="images/shuji4.jpg" alt="" width="56" height="56">
                        </td>
                        <td >2017-07-15</td>
                        <td >叙述内容</td>
                        <td class="td-status">
             ...
             <div id="pagerMain" class="apage"><font color=#333 title="首页">首页</font> 
                ...
                <div class="layui-tab-item">
                    ...
                    <xblock>
          <button class="layui-btn" onclick="download_voidadd('添加信息','download_voidadd.jsp','600','500')"><i class="layui-icon">&#xe608;</i>添加</button>
          <button class="layui-btn layui-btn-danger"><i class="layui-icon"><img src="images/look2.png" width="15" height="15"></img></i>查看</button>
          ...
          <span class="x-right" style="line-height:40px">共有数据：88 条</span></xblock>
                ...
                <tbody id="x-img">
                    <tr>
                        ...
                        <td width="7%">心理视频</td>
                        <td align="center" width="7%">
                            <img src="images/shipin1.jpg" alt="" width="56" height="56">
                        </td>
                        <td >2017-07-15</td>
                        <td >叙述内容</td>
                        <td class="td-status">
                        ...
                        <td class="td-manage">
                            ...
                            <a title="修改" href="javascript:;" onclick="download_voidedit('修改','download_voidedit.jsp','4','','510')"
                            class="ml-5" style="text-decoration:none">
                                <i class="layui-icon">&#xe642;</i>
                            </a>
                            <a title="删除" href="javascript:;" onclick="banner_del(this,'1')" 
                    ...
                    <tr>
                        ...
                        <td width="7%">产品视频</td>
                        <td align="center" width="7%">
                            <img src="images/shipin2.jpg" alt="" width="56" height="56">
                        </td>
                        <td >2017-07-15</td>
                        <td >叙述内容</td>
                        <td class="td-status">
                    ...
                    <tr>
                        ...
                        <td width="7%">公司视频</td>
                        <td align="center" width="7%">
                            <img src="images/shipin3.jpg" alt="" width="56" height="56">
                        </td>
                        <td >2017-07-15</td>
                        <td >叙述内容</td>
                        <td class="td-status">
                    ...
                    <tr>
                        ...
                        <td width="7%">健康讲座</td>
                        <td align="center" width="7%">
                            <img src="images/shipin4.jpg" alt="" width="56" height="56">
                        </td>
                        <td >2017-07-15</td>
                        <td >叙述内容</td>
                        <td class="td-status">
                    ...
                    <tr>
                        ...
                        <td width="7%">催眠视频</td>
                        <td align="center" width="7%">
                            <img src="images/shipin5.jpg" alt="" width="56" height="56">
                        </td>
                        <td >2017-07-15</td>
                        <td >叙述内容</td>
                        <td class="td-status">
