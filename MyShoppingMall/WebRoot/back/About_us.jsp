...
<html>
    ...
    <body>
        ...
        <form class="layui-form x-center" action="" style="width:500px">
            ...
            <xblock><button class="layui-btn layui-btn-danger" onclick="delAll()"><i class="layui-icon">&#xe640;</i>批量删除</button><button class="layui-btn" onclick="about_us_add('添加用户','about_us_add.jsp','600','500')"><i class="layui-icon">&#xe608;</i>添加</button><span class="x-right" style="line-height:25px">共有数据：88 条</span></xblock>
            <table class="layui-table">
                ...
                <tbody id="x-img">
                    <tr>
                        ...
                        <td align="center">
                            <img src="images/img1.jpg" width="100" alt="">
                        </td>
                        ...
                        <td class="td-manage">
                            ...
                            <a title="修改" href="javascript:;" onclick="about_us_edit('修改','about_us_edit.jsp','4','','510')"
