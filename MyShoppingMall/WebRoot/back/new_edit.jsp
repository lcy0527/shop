...
<body>
	<div class="x-body">
		<form class="layui-form" action="news?method=update&id=${news.id}" method="post"
			...
			<div class="layui-form-item">
				<label class="layui-form-label">图片 </label> <img id="" width="400"
					src="/MyShoppingMall/back/images/img1.jpg">
			</div>
			<div class="layui-form-item">
	...
	<script src="/MyShoppingMall/back/lib/layui/layui.js" charset="utf-8">
		
	</script>
	<script src="/MyShoppingMall/back/js/x-layui.js" charset="utf-8">
