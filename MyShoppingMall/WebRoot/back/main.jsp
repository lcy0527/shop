...
<html>
    ...
    <body>
        ...
        <form class="layui-form x-center" action="" style="width:500px">
          ...
          <xblock>
          <button class="layui-btn" onclick="person_add('添加信息','person_add.jsp','600','500')"><i class="layui-icon">&#xe608;</i>添加</button>
            ...
            <table class="layui-table">
                ...
                <tbody>
                    <tr>
                        ...
                        <td>2017年7月18日12时00分00秒</td>
                        <td class="td-manage">
                            <a title="查看" href="javascript:;" onclick="person_look('查看','person_look.jsp','4','','510')"
