            ...
            <div class="am-tabs" id="doc-my-tabs">
                ...
                <div class="am-tabs-bd">
                    <div class="am-tab-panel am-active">
                        <form method="post" id="emailForm" action="../../register">
                            ...
                            <div class="login-links">
                                <!--<label for="reader-me">-->
                                <input id="reader-me" name="click" type="checkbox"><span>点击表示您同意商城《服务协议》</span>
                                <!--</label>-->
                            </div>
                            <div class="am-cf">
                    ...
                    <div class="am-tab-panel">
                        <form method="post" id="phoneForm">
                            ...
                            <div class="login-links">
                                <!--<label for="reader-me">-->
                                <input type="checkbox" name="click"> 点击表示您同意商城《服务协议》
                                <!--</label>-->
                            </div>
                            <div class="am-cf">
                                <input type="submit" name="" value="注册" class="am-btn am-btn-primary am-btn-sm am-fl">
